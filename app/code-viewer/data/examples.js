...
export const APP_EXTENDED_STRUCTURE = `
    my-project/
        │
        ├── index.html
        ├── init.js
...
export const COMPONENT_CONFIG_STRUCTURE = `
    {
        "modularCube": {
            "application": {
                "name": "app-body",           # Name of the application root component.
                "files": {
                    "html": {
                        "path": ""            # Path to the application HTML template (Optinal).
                    },
                    "css": {
                        "path": "./style.css" # Path to the application CSS styles (Optinal).
                    }
                },
                "behavior": {
                    "apendToBody": false,     # Indicates whether the application should be appended to the body tag automatically.
                    "lazyLoading": false,     # Enables deferred loading of the application until it is needed.
                    "fps": 0,                 # Defines the rendering/update frame rate. 0 disables the limit.
                    "debug": false            # Enables debug mode for logging and diagnostics.
                }
            },
            "components": []                  # List of components registered with the application.
        }
    }
`;
...
export const COMPONENT_EVENT_TEMPLATE = `
    <div clickEvent="this.addNumber(5)"></div>
    <div clickEvent="this.subtractNumber(3)"></div>
    <div resizeEvent="this,reset()"></div>
`;
...
export const APPLICATION_INLINE_CONTENT = `
    <app-body>

        <template>

            <h1>Welcome to ModularCube</h1>
...
export const APPLICATION_EXTERNAL_CONTENT = `
    <app-body></app-body>
`;

export const APPLICATION_HTML_CONFIG = `
    {
        "application": {
            "name": "app-body",
            "files": {
